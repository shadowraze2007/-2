#вот ошибка 
"""
qt.qpa.plugin: Could not find the Qt platform plugin "windy\adapter/../..\debugpy\launcher' '51741' '--' 'C:\Users\Камильчик\Documents\cv2\main.py' windows"" in ""oft\WindowsApps\python3.10.exe' 'c:\Users\Камильчик\.vscode\ext
This application failed to start because no Qt platform plebugpy\adapter/../..\debugpy\launcher' '51759' '--' 'C:\Users\Камильчик\Documents\cv2\main.py' ugin could be initialized. Reinstalling the application maows" in ""y fix this problem.
"""
import pyttsx3
...
class Assistant(QtWidgets.QMainWindow, interface.Ui_MainWindow, threading.Thread):
    ...
    def __init__(self):
        ...
        self.ndels = ['камилла', 'камиллушка', 'эй камилла', 'ками', 'ладно', 'не могла бы ты', 'пожалуйста',
                      'текущее', 'сейчас']
